...
import com.epam.cashier.CustomLoggerFactory;
import com.epam.cashier.CustomLoggerFactory.CustomLogger;
...
public class VisaPaymentSystemService implements PaymentSystemService {
	...
	private final static CustomLogger logger2 = CustomLoggerFactory.getLogger(VisaPaymentSystemService.class);
	...
	public BalanceInfo getBalanceInfo(GetBalanceTransactionPayload payload) {
		...
		logger2.logOperation("Our custom logger impl without exp", () -> {
			return null;
		});

		logger2.logOperation("Our custom logger impl with exp", () -> {
